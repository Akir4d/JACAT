<?php
	...
	$this->set_js_config($this->default_theme_path.'/datatables-bootstrap3/js/datatables-edit.js');
...
function ciBsOnHandler(el) {console.log($(el).closest('form').attr('action'))};

function ciBsOffHandler(el) {console.log($(el).closest('form').attr('action'))};
</script>
