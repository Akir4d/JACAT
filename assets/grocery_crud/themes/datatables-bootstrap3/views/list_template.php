<?php
	...
	$this->set_js($this->default_theme_path.'/datatables-bootstrap3/js/datatables.js?v=0.2.61');
...
<script type='text/javascript'>
	...
	function ciBsOnHandler(el) {console.log($(el).closest('tr').attr('id'))};
	function ciBsOffHandler(el) {console.log($(el).closest('tr').attr('id'))};
	<?php
...
?>
<div class="grocerycrud-container box"><div class="box-body">
